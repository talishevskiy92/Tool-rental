...
//TDateTime hh = DM->ADOQ4->FieldByName("God_kinec")->DataType;
 //TDateTime hh = DM->ADOQ4->FieldByName("")->Value;
		  if(dd < Date())
   {
...
void __fastcall TForm3::DBGrid3DrawColumnCell(TObject *Sender, const TRect &Rect,
          int DataCol, TColumn *Column, TGridDrawState State)
{
TDateTime hh = DM->ADOQ4->FieldByName("God_kinec")->Value;

		  if(hh.FormatString("HH:mm") < Time())
   {
...
void __fastcall TForm3::DBGrid3DblClick(TObject *Sender)
{
 Form17->Show();
 Form17->Edit1->Text= Form3->DBGrid3->DataSource->DataSet->Fields->FieldByName("Nomer_P")->Text;


}
//---------------------------------------------------------------------------

void __fastcall TForm3::DBGrid2DblClick(TObject *Sender)
{
Form17->Show();
 Form17->Edit1->Text= Form3->DBGrid2->DataSource->DataSet->Fields->FieldByName("Nomer_P")->Text;
